...
function App() {
  ...
  const loadWeb3 = async () => {
    if (typeof window.ethereum !== "undefined") {
      ...
      if (networkId !== 5777) {
        console.log("explore", config.NETWORKS);
  ...
  const mintNFTHandler = async () => {
    ...
    if (openPunks && account) {
      ...
      await openPunks.methods
        ...
        //.send({ from: account, value: MINT_COST })
    ...
    <div>
      ...
      <main>
        <section id="welcome" className="welcome">
          <Row className="header my-3 p-3 mb-0 pb-0">
            <Col xs={12} md={12} lg={8} xxl={8}>
              <h1>Cess Cohort Genesis</h1>
              <p className="sub-header">Minting on March 22 2024</p>
            </Col>
          ...
          <Row className="flex m-3">
            <Col md={5} lg={4} xl={5} xxl={4} className="text-center">
              <img src={`/cess.jpg`} alt="Crypto Punk" className="showcase" />
            </Col>
            <Col md={5} lg={4} xl={5} xxl={4}>
              ...
              <p className="text">Cess Cohort is unique!</p>
        ...
        <section id="about" className="about">
          <Row className="flex m-3">
            <h2 className="text-center p-3">Cess Cohort Collection</h2>
            <Col md={5} lg={4} xl={5} xxl={4} className="text-center">
              <img
                src={"/collage.png"}
